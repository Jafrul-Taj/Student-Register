...
namespace SchollRegister.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            student.StudentCourses = _context.StudentCourses.Where(Id => Id.StudentId == 1).ToList();

            foreach (var a in student.StudentCourses)
            {
                //   a.Course = _context.Courses.Where(Id => Id.Id == a.CourseId).FirstOrDefault();
                a.Course = await _context.Courses.FirstOrDefaultAsync(m => m.Id == a.CourseId);
            }
